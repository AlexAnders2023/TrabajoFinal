...
#catalogo = Catalogo(host='localhost', user='root', password='', database='miapp') # ruta local

#catalogo.agregar_producto('Teclado USB 101 teclas', 10, 4500, 'teclado.jpg', 101) //se cargan ejemplos de manera local
#catalogo.agregar_producto('Mouse USB 3 botones', 5, 2500, 'mouse.jpg', 102)
#catalogo.agregar_producto('Monitor LED', 5, 25000, 'monitor.jpg', 103)

catalogo = Catalogo(host= bd.host,  user= bd.user, password= bd.password, database= bd.database)
# los datos de las variables estan guardados en datosConexion.py 

# Carpeta para guardar las imagenes
#ruta_destino = './static/imagenes/' #ruta local
ruta_destino = '/home/Alex0Anders/mysite/static/imagenes'
